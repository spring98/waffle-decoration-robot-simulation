...
k=10, c=10인 상태로 제어한 결과입니다.<br/>
오른쪽 3개의 그래프는 end-effector의 x, y, z 좌표를 나타낸 그래프이고, 왼쪽 4개의 그래프는 각 조인트 프사이,세타1,2,3의 그래프입니다.<br/>
노란색이 desired 경로, 파란색이 실제 로봇이 움직인 경로입니다. <br/>
...
c값을 50으로 올려서 제어를 진행하였지만, 큰 변화는 관찰할 수 없었습니다.<br/>
...
k값을 유지하고 c를 낮춘상태에서 제어했을때도 경로를 잘 추종하였습니다.<br/>
결과적으로 일반적인 경우에서는 k=30, c=10으로 적절한 파라미터를 구할 수 있었습니다.
<br/><br/><br/>
...
외란을 고려하여 추가적으로 시뮬레이션을 진행하였습니다. <br/>
disturbance = 0.1 sin(t)<br/>
